<!-- ***************************************************************************************
  Page Name  : ControllerPgm4.php
  Author     : Enzo Gomes
  Your URL   : ocelot-aul.fiu.edu/~edeol005
  Course     : CGS4854
  Program #  : Program 4
  Purpose    : Connects to MySQL to create the info table using program4.php input data and
               calls save, find, modify, delete, or clear files when needed, as well as extra buttons Help 
               About and Leads
  Due Date   : 04/16/2025
  Certification: 
